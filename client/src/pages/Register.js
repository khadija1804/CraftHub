...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('Sending register request with:', { email, password, role, nom, prenom }); // Debug log
      ...
      console.error('Register error:', err.response?.data || err); // Debug error
      setError(err.response?.data?.error || 'Échec de l\'inscription. Vérifiez vos informations.');
    }
  };
  ...
  return (
    <div style={{ fontFamily: '"Inter", "Segoe UI", "Roboto", sans-serif', backgroundColor: '#f8f1e9', color: '#3a2f1a', margin: 0, padding: 0, minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      {/* Main Content - Modern Registration Form */}
      <section style={{ 
        maxWidth: '1400px', 
        margin: '100px auto', 
        padding: '80px 40px', 
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <p style={{ 
              ...
              margin: 0,
              opacity: 0.8
            }}>Créez votre compte et commencez votre aventure artisanale</p>
          </div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <select
                  ...
                  style={{ 
                    ...
                    boxShadow: '0 4px 15px rgba(0,0,0,0.05)',
                    appearance: 'none',
                    backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%23d4a373' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='m6 8 4 4 4-4'/%3e%3c/svg%3e")`,
                ...
                >
                  <option value="client">🛍️ Client - Découvrir et acheter des créations</option>
                  <option value="artisan">🎨 Artisan - Vendre et partager vos créations</option>
                </select>
              </div>
            </div>
          ...
          <div style={{ 
            ...
            <p style={{ 
              ...
              <a href="/terms" style={{ color: '#d4a373', textDecoration: 'none', fontWeight: 600 }}> conditions d'utilisation</a> 
              {' '}et notre{' '}
              <a href="/privacy" style={{ color: '#d4a373', textDecoration: 'none', fontWeight: 600 }}>politique de confidentialité</a>
            </p>
          </div>
        </div>
      </section>
